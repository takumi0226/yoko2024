...
bool choirbot_interfaces__msg__position_task__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("choirbot_interfaces.msg._position_task.PositionTask", full_classname_dest, 51) == 0);
  }
  choirbot_interfaces__msg__PositionTask * ros_message = _ros_message;
  {  // coordinates
...
{
  /* NOTE(esteve): Call constructor of PositionTask */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("choirbot_interfaces.msg._position_task");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PositionTask");
