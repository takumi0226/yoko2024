...
#include "choirbot_interfaces/msg/detail/position_task__rosidl_typesupport_fastrtps_c.h"
...
using _PositionTask__ros_msg_type = choirbot_interfaces__msg__PositionTask;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PositionTask__ros_msg_type * ros_message = static_cast<const _PositionTask__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _PositionTask__ros_msg_type * ros_message = static_cast<_PositionTask__ros_msg_type *>(untyped_ros_message);
  // Field name: coordinates
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
    ...
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->coordinates, size)) {
      return "failed to create array for field 'coordinates'";
    }
    auto array_ptr = ros_message->coordinates.data;
...
static uint32_t _PositionTask__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_choirbot_interfaces__msg__PositionTask(
...
{
  return max_serialized_size_choirbot_interfaces__msg__PositionTask(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_PositionTask = {
...
static rosidl_message_type_support_t _PositionTask__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PositionTask,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, choirbot_interfaces, msg, PositionTask)() {
  return &_PositionTask__type_support;
}
